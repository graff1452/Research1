...
print("🚀 BERT CoLA QLoRA Fine-tuning (4-bit base, JSON & NVML like sample)")
print("=" * 70)

# --------------------------- Config ---------------------------
MODEL_NAME   = "bert-base-uncased"
OUTPUT_DIR   = "./bert-cola-qlora"
BATCH_SIZE   = 32
LEARNING_RATE= 1e-5
EPOCHS       = 5
MAX_LENGTH   = 128
...
# BERT already has PAD token; keep right padding
...
# Prepare for k-bit training (enables input grads, etc.)
