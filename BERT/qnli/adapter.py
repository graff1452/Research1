...
print("🚀 BERT QNLI Adapter Fine-tuning (with checkpoint-averaged power/VRAM)")
print("=" * 72)

# ---- Config ----
MODEL_NAME   = "bert-base-uncased"
TASK_NAME    = "qnli"
OUTPUT_DIR   = "./bert-qnli-adapters"
...
# Keep the same mapping as your original script (0 entailment, 1 not_entailment)
