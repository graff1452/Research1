...
print("🚀 BERT QNLI LoRA+ Fine-tuning (with JSON & NVML-like sampling)")
print("=" * 70)

# --------------------------- Config ---------------------------
MODEL_NAME     = "bert-base-uncased"
OUTPUT_DIR     = "./bert-qnli-loraplus"
BATCH_SIZE     = 32
LEARNING_RATE  = 1e-5
EPOCHS         = 5
MAX_LENGTH     = 128
...
# BERT already has pad_token; no EOS padding needed.
...
# --------------------------- LoRA config ---------------------------
print("\n🔧 Configuring LoRA...")
# For BERT, attention projection layers are typically named: query, key, value.
