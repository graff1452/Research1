...
print("🚀 BERT QNLI QLoRA Fine-tuning (4-bit base, JSON & NVML-like sampling)")
print("=" * 70)

# --------------------------- Config ---------------------------
MODEL_NAME    = "bert-base-uncased"
OUTPUT_DIR    = "./bert-qnli-qlora"
BATCH_SIZE    = 32
LEARNING_RATE = 1e-5
EPOCHS        = 5
MAX_LENGTH    = 128
...
# Prepare for k-bit training (e.g., layer norms cast, etc.)
...
# --------------------------- LoRA on top ---------------------------
print("\n🔧 Configuring LoRA...")
# For BERT attention linear layers: query, key, value (and output.dense exists too).
...
# --------------------------- Optimizer & Scheduler ---------------------------
# PagedAdamW8bit is common for QLoRA runs when bitsandbytes is available.
...
updates_per_epoch = len(tokenized["train"]) // training_args.per_device_train_batch_size
...
# --------------------------- Train ---------------------------
print("\n🚀 Starting QLoRA fine-tuning (QNLI)…")
t0 = time.time()
