...
print("🚀 BERT SST-2 Adapter Fine-tuning (with checkpoint-averaged power/VRAM)")
print("=" * 72)

# ---- Config ----
MODEL_NAME   = "bert-base-uncased"
TASK_NAME    = "sst2"
OUTPUT_DIR   = "./bert-sst2-adapters"
...
# For BERT models with adapters, use add_classification_head(task_name, ...)
...
def predict(text: str):
    ...
    # model.device is not always defined with device_map="auto"; use first param device.
