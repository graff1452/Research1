...
print("🚀 TinyLlama QNLI LoRA Fine-tuning (with checkpoint-averaged power/VRAM)")
print("=" * 70)
...
BATCH_SIZE   = 32
LEARNING_RATE= 1e-5       # LoRA often tolerates higher (e.g., 5e-5 ~ 2e-4)
EPOCHS       = 3
MAX_LENGTH   = 128
LOG_STEPS    = 50
EVAL_STEPS   = 200
...
print("\n🎯 Testing individual predictions (QNLI-style)…")

def test_prediction(question, sentence, model, tokenizer):
    inputs = tokenizer(question, sentence, return_tensors="pt", truncation=True, padding=True, max_length=MAX_LENGTH)
...
print("=" * 70)
print("🏁 LORA FINE-TUNING SUMMARY (QNLI)")
print("=" * 70)
