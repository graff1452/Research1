...
print("🚀 BERT CoLA BitFit Fine-tuning (with checkpoint-averaged power/VRAM)")
print("=" * 60)
...
# BERT has a PAD token by default
...
# Unfreeze classifier head (BERT classification head is typically `classifier.*`)
...
if hasattr(nvml_cb, "summary"):
    ...
    num_ckpt_samples = s.get("num_checkpoint_samples", s.get("num_checkpoints_sampled", 0))
...
results = {
    ...
    "num_checkpoint_samples": int(num_ckpt_samples),
