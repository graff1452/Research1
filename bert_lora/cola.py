...
print("🚀 BERT CoLA LoRA Fine-tuning (with checkpoint-averaged power/VRAM)")
print("=" * 70)

# --------------------------- Config ---------------------------
MODEL_NAME    = "bert-base-uncased"
OUTPUT_DIR    = "./bert-cola-lora"
BATCH_SIZE    = 32
LEARNING_RATE = 1e-5
EPOCHS        = 5
MAX_LENGTH    = 128
...
# BERT already has a PAD token; no eos/pad hack needed.
...
# --------------------------- LoRA config ---------------------------
print("\n🔧 Configuring LoRA...")
# BERT attention projections are named "query", "key", "value"
...
# keep your version-compatibility pattern:
