...
print("🚀 TinyLlama CoLA Full Fine-tuning (with checkpoint-averaged power/VRAM)")
print("=" * 60)

# ------------ Config ------------
MODEL_NAME   = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"
OUTPUT_DIR   = "./tinyllama-cola-fullft"   # CHANGED
MAX_LENGTH   = 128
EPOCHS       = 3
BATCH_SIZE   = 32
GRAD_ACCUM   = 2
...
mcc = evaluate.load("matthews_correlation")         # CHANGED
...
def predict(text: str):
    ...
    with torch.no_grad():
        ...
        label = "ACCEPTABLE" if cls == 1 else "UNACCEPTABLE"   # CHANGED
        conf = probs[cls].item()
    return label, conf
