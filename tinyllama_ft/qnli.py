...
print("🚀 TinyLlama QNLI Full Fine-tuning (with checkpoint-averaged power/VRAM)")
print("=" * 60)

# ------------ Config ------------
MODEL_NAME   = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"
OUTPUT_DIR   = "./tinyllama-qnli-fullft"
MAX_LENGTH   = 128
EPOCHS       = 3
BATCH_SIZE   = 32
GRAD_ACCUM   = 2
...
args_kwargs = dict(
    ...
    metric_for_best_model="eval_accuracy",  # QNLI = accuracy
