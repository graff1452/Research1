...
print("🚀 TinyLlama QNLI QLoRA Fine-tuning (4-bit base, JSON & NVML-like sampling)")
print("=" * 70)

# --------------------------- Config ---------------------------
MODEL_NAME    = "TinyLlama/TinyLlama-1.1B-Chat-v1.0"
OUTPUT_DIR    = "./tinyllama-qnli-qlora"
BATCH_SIZE    = 32
LEARNING_RATE = 1e-5
EPOCHS        = 3
MAX_LENGTH    = 128
...
# --------------------------- Optimizer & Scheduler ---------------------------
optimizer = bnb.optim.PagedAdamW8bit(model.parameters(), lr=training_args.learning_rate, weight_decay=training_args.weight_decay)
